6. Описание файлов проекта, .env и инструкция по запуску
...
> **Важно:** Не рекомендуется запускать всё одной командой через run_full_pipeline.py — для отладки и обновления данных удобнее выполнять этапы по отдельности.
